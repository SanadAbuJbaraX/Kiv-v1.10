...
class KivError:
		...
		def as_string(self):
				...
				return result
class IllegalCharacterError(KivError):
		def __init__(self, pos_start, pos_end, details):
				super().__init__(pos_start, pos_end, 'Illegal Character', details)
class ImportError(KivError):
		def __init__(self, pos_start, pos_end, details):
				super().__init__(pos_start, pos_end, 'ImportError', details)
class InvalidSyntaxError(KivError):
		def __init__(self, pos_start, pos_end, details=''):
				super().__init__(pos_start, pos_end, 'Invalid Syntax', details)
class RuntimeError(KivError):
...
class ExpectedCharError(KivError):
	def __init__(self, pos_start, pos_end, details):
		super().__init__(pos_start, pos_end, 'Expected Character', details)
class TypeError(KivError):
	def __init__(self, pos_start, pos_end, details):
